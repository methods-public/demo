...
def load_current_resource
  ...
  @nexus_configuration_object  = @new_resource.nexus_configuration
  @current_resource            = Chef::Resource::ArtifactLegacyDeploy.new(@new_resource.name)
...
private
  ...
  def retrieve_from_http
    artifact_legacy_file cached_tar_path do
  ...
  # Defines a artifact_legacy_file resource call to download an artifact from Nexus.
  #
  # @return [void]
  ...
  # Defines a artifact_legacy_file resource call to download an artifact from S3.
  #
  # @return [void]
