...
default[cookbook_name]['rndc_bin'] = '/usr/sbin/rndc'
...
default[cookbook_name]['sysconfig_file'] = '/etc/sysconfig/named'
default[cookbook_name]['sysconfig_config'] = {
  # OPTIONS="whatever"     --  These additional options will be passed to named
  #                            at startup. Don't add -t here, enable proper
  #                            -chroot.service unit file.
  #                            Use of parameter -c is not supported here.
  #                            Extend systemd named*.service instead. For more
  #                            info please read the following KB article:
  #                            https://access.redhat.com/articles/2986001
  'OPTIONS' => '',
  # DISABLE_ZONE_CHECKING  --  By default, service file calls named-checkzone
  #                            utility for every zone to ensure all zones are
  #                            valid before named starts. If you set this
  #                            option to 'yes' then service file doesn't
...
# Statistics Channels
default[cookbook_name]['statistics-channels'] = []
