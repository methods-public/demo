...
default['omni_ruby']['source_version'] = '1.9.3-p551'
default['omni_ruby']['source_install_dir'] = '/usr/local'
default['omni_ruby']['source_rubygems_version'] = '1.8.24'
default['omni_ruby']['source_rubygems_force'] = false
default['omni_ruby']['source_optimize'] = false
default['omni_ruby']['source_optimization_level'] = 1
default['omni_ruby']['source_falcon_patch'] = false
default['omni_ruby']['source_package_dependencies'] = value_for_platform_family(
