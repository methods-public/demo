...
default['omni_ruby']['ree_url'] = 'https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.com/rubyenterpriseedition/ruby-enterprise_1.8.7-2012.02_amd64_ubuntu10.04.deb'
default['omni_ruby']['ree_source_url'] = 'https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.com/rubyenterpriseedition/ruby-enterprise-1.8.7-2012.02.tar.gz'
default['omni_ruby']['ree_package_dependencies'] = value_for_platform_family(
