...
# The Dynatrace Memory Analysis Server will be installed into the directory
# node['dynatrace']['memory_analysis_server']['linux']['installer']['prefix_dir']/dynatrace-$major-$minor-$rev,
# where $major, $minor and $rev are given by the installer. A symbolic link to the actual installation directory will be
# created in node['dynatrace']['memory_analysis_server']['linux']['installer']['prefix_dir']/dynatrace.
...
default['dynatrace']['memory_analysis_server']['linux']['installer']['file_url'] = 'http://files.dynatrace.com/downloads/OnPrem/dynaTrace/7.0/7.0.0.2469/dynatrace-analysisserver-7.0.0.2469-linux-x86.jar'
