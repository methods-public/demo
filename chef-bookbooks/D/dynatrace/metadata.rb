...
license 'MIT'
description 'This cookbook is deprecated. Please use dynatrace-appmon'
...
recipe 'dynatrace', 'This cookbook id deprecated. Please use https://supermarket.chef.io/cookbooks/dynatrace-appmon'
