...
unless node['platform_version'].to_i == 6
  ::Chef::Log.warn('yum_mesosphere cookbook not currently supported on '\
    "#{node['platform']} #{node['platform_version']}")
  return
end

repos = %w(mesosphere mesosphere-noarch mesosphere-source)
