...
case node['platform']
when "amazon"
  default['yum']['nodesource_4x']['baseurl'] = 'https://rpm.nodesource.com/pub_4.x/el/6/x86_64/'
else
  case node['platform_version'].to_i
  when 6
    default['yum']['nodesource_4x']['baseurl'] = 'https://rpm.nodesource.com/pub_4.x/el/6/x86_64/'
  when 7
    default['yum']['nodesource_4x']['baseurl'] = 'https://rpm.nodesource.com/pub_4.x/el/7/x86_64/'
  end
end
