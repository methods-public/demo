...
# node['cloudinsight-agent']['elasticsearch']['instances'] = [
#   {
...
# should enable you to slice and dice as you please.
#
# Example:
#
# node['cloudinsight-agent']['elasticsearch']['instances'] = [
...
cloudinsight_agent_monitor 'elastic' do
  instances node['cloudinsight-agent']['elasticsearch']['instances']
end
